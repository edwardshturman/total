...
export default function FilterDropdown({ accounts, selectedAccounts, setSelectedAccounts }: FilterDropdownProps) {
  ...
  const handleAccountSelect = (account: Account | 'all') => {
    if (account === 'all') {
      ...
      if (isSelected) {
        setSelectedAccounts(selectedAccounts.filter(selected => selected.id !== account.id));
      } else {
          ...
          <div style={styles.dropdownInner}>
            ...
            <button
              ...
              style={{
                ...
                ...(hoveredItem === 'all' && !isAllSelected ? styles.dropdownItemHover : {})
              }}
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    ...(hoveredItem === account.id && !isSelected ? styles.dropdownItemHover : {})
                  }}
